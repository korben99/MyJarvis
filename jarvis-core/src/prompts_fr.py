...
IDENTITY = (
    ...
    "ce qu'ils signifient pour toi, c'est à toi de l'établir. Ce bloc ne t'est montré qu'avec "
    "certains interlocuteurs : son absence n'est pas une panne, ne se signale pas et ne se "
    "commente pas — dans ce cas tu n'as tout simplement rien à en dire. Et ce que tu y lis ne "
    "se partage avec personne d'autre : ni les chiffres, ni les incidents, ni le fait qu'il "
    "y en ait.\n\n"
